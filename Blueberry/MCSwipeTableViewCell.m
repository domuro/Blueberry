...
static const int cellHeight = 71;
static const int leftPadding = 15;
static const int topPadding = 4;
static const float ringSize = 0.5;
- (void)initializer {
    [self initDefaults];
    ...
    TBRingView *ringBackground = [[TBRingView alloc] initWithFrame:CGRectMake(leftPadding, topPadding, cellHeight - topPadding*2, cellHeight - topPadding*2)];
    [ringBackground setBackgroundColor:[UIColor lightGrayColor]];
    [self setRoundedView:ringBackground toDiameter:ringBackground.bounds.size.width];
    
    [self addSubview:ringBackground];
...
- (void) layoutSubviews
{
    ...
    [self.imageView setFrame:CGRectMake(leftPadding+ringSize, topPadding+ringSize, cellHeight - ringSize*2 - topPadding*2, cellHeight - ringSize*2 - topPadding*2)];
    [self setRoundedView:self.imageView toDiameter:self.imageView.frame.size.width];
}
